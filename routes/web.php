...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::group(['prefix'=>'cong-trinh'], function(){
        ...
        Route::get('{id}/{slug}.html','ConstructionController@detail')->name('detailConstruction');
    });
    ...
    Route::post('form','TicketController@FormTicket')->name('FormTicket');
    Route::post('form/sentMail','TicketController@SentMail')->name('SentMail');
    ...
    Route::get('chi-tiet-san-pham/{cate}/{slug}.html','ProductController@detail_product')->name('detailProduct');
